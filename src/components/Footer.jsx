...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-between px-20 py-10 text-white bg-blue-950 lg:flex-row">
      <section
        id="socialMedia"
        className="w-fit min-h-[75px] flex flex-col justify-between items-center"
      >
      ...
      <section className="my-10 lg:my-0">
        <ul className="flex flex-col text-center text-blue-900 gap-y-2 lg:block columns-1 lg:columns-2 lg:text-left">
          <li className="cursor-pointer text-slate-400 hover:text-green-500">
            About Use
          </li>
          <li className="cursor-pointer text-slate-400 hover:text-green-500">
            Contact
      ...
      <section className="w-fit min-h-[75px] flex flex-col justify-between items-center">
        <div className="bg-white rounded-full w-fit">
          <Button className="gradientButton opacityHover">
            Request Invite
          </Button>
        </div>
        <p className="mt-4 text-center text-blue-200 lg:mt-0">
